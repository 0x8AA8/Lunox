...
module.exports = {
    ...
    description_localizations: {
        ...
        ko: "볼륨 설정",
        "zh-CN": "设置音量",
        "en-GB": "Set the volume",
        "es-ES": "Ajustar el volumen",
        de: "Lautstärke einstellen",
        "pt-BR": "Definir o volume",
    ...
    options: [
        {
            ...
            description_localizations: {
                ...
                ko: "볼륨 값 입력",
                "zh-CN": "输入音量值",
                "en-GB": "Provide volume value",
                "es-ES": "Proporciona el valor del volumen",
                de: "Lautstärkewert eingeben",
                "pt-BR": "Forneça o valor do volume",
                ru: "Укажите значение громкости",
            },
            type: 4,
            min_value: minVolume,
            max_value: maxVolume,
